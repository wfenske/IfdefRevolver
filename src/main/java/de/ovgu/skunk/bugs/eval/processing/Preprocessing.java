package de.ovgu.skunk.bugs.eval.processing;
...
import de.ovgu.skunk.bugs.eval.main.Smell;
...
public class Preprocessing {
	 ...
	 * 
	 * @param bugMap
	 *            TreeMap mit allen Dateien im ChangedFile-Objektformat
	 * @param startDate
	 * @param endDate
	...
	private static Map<FileChangeHunk, String> getCurMap(Map<FileChangeHunk, String> bugMap,
			Date startDate, Date endDate) {
		Map<FileChangeHunk, String> curBugMap = new HashMap<FileChangeHunk, String>();
		for (FileChangeHunk changedFile : bugMap.keySet()) {
