...
public class Evaluation {
	...
	public static enum CorOverviewMetric {
		 ...
		 * 
		 * @param smellsInFile
		 *            Information about the smells present within a file
	...
	public static class FixesAndSlocTab {
		 ...
		 */
		public List<Integer> smellySloc = new ArrayList<Integer>();

		/**
		 * SLOC of non-smelly files (irregardless of smell)
		 */
		public List<Integer> nonSmellySloc = new ArrayList<Integer>();
