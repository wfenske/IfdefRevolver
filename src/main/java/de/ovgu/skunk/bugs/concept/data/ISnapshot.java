...
public interface ISnapshot {
    ...
    /**
     * @param expectedNumberOfBugfixes
     *            Number of expected bug-fix commits
     * @throws AssertionError
     *             if the snapshot does not contain the specified number of
     *             bug-fix commits
     */
     ...
     * 
     * @param filesInNextSnapshotCheckout
     *            All the files that belong to the checkout of the following
     *            snapshot (second parameter)
     * @param nextSnapshot
     *            The snapshot that the files passed as the first argument
     *            belong to
